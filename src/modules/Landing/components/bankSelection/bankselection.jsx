...
const BankSelection = ({ selectedBank, handleBank }) => {
    return (
        ...
        <div className="btn-left-paymain">
            <div className={`d-flex mb-2 position-relative${selectedBank === 'BCA Transfer' ? 'selected' : ''}`} id='BCA Transfer' onClick={() => handleBank('BCA Transfer')}>
            ...
            <hr />
            <div className={`d-flex mb-2 position-relative ${selectedBank === 'BNI Transfer' ? 'selected' : ''}`} id='BNI Transfer' onClick={() => handleBank('BNI Transfer')}>
            ...
            <hr />
            <div className={`d-flex mb-2 position-relative ${selectedBank === 'Mandiri Transfer' ? 'selected' : ''}`} id='Mandiri Transfer' onClick={() => handleBank('Mandiri Transfer')}>
